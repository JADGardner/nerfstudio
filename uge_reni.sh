...
#$ -o "outputs/uge_logs/reni/output_${DATE_STR}_$JOB_ID.txt"     # output file

source ~/.bashrc

cd /data/home/$USER/code/nerfstudio

TRAINING_COMMAND="ns-train reni --vis wandb"  # Replace with your training command
